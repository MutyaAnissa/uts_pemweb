...
<html>
  <head>
    <title>DATABASE BUS TRANS UPN</title>
    <style>
        .status_aktif {
  ...
  <body>
        <nav>
          <div>
            <h2><center>SELAMAT DATANG DI BUS TRANS UPN</center></h2>
            <p>Berikut ini aksi yang dapat anda pilih : </p>
            <ol>
              <li>
                <a href="bus.php">Data Bus Trans UPN</a>
              </li>
              <li>
        ...
        <main role="main">
          <?php 
            if (@$_GET['status']!==NULL) {
              $status = $_GET['status'];
              if ($status=='yes') {
                echo '<br><div>Id Bus telah terhapus</div>';
              }
           ...
           ?>
          <h2 style="margin: 20px 0 20px 0;">DATA BUS TRANS UPN</h2>
          <div>
            <table border="1">
              <thead>
                <tr>
